    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          onClick: () => onViewChange('usuarios', 'Usuarios', [{ label: 'Home', path: '/' }, { label: 'Autenticación y autorización', path: '/auth' }]),
          view: 'usuarios',
        }
      ]
    },
      ...
      items: [
        {
          ...
          onClick: () => onViewChange('disabilitys', 'Disabilitys', [{ label: 'Home', path: '/' }, { label: 'Usuarios', path: '/usuarios' }]),
          view: 'disabilitys',
        },
        {
          title: "Personas",
          icon: <PeopleIcon sx={{ color: '#9c88ff' }} />,
          onClick: () => onViewChange('personas', 'Personas', [{ label: 'Home', path: '/' }, { label: 'Usuarios', path: '/usuarios' }]),
          view: 'personas',
        }
      ]
    }
